...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean insertData(String name, String type, String time, String day) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public boolean updateData(String id, String name, String type, String time, String day) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
